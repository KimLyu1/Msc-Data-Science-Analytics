...
microsoft <- na.omit(microsoft) %>% select(-c(Close, compound))
...
```{r}
# epoch = 12 
# (4.279228 + 3.249981 + 4.180111 + 3.141273 + )/5

# epoch = 30
# (3.176552 + )/5

# epoch = 10
# (3.605838 + 4.021565 + 3.592408 + 3.564883 + 4.195087)/5

# re-jilu
# (2.64028 + 3.244462 + 2.949549 + 3.260004 + 3.31916)/5
```
